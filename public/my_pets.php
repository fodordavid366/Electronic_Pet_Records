...
<div class="container-fluid register-container mt-5">
        <div class="d-flex justify-content-center align-items-center bg-light"  style="min-height: calc(100vh - 56px);">
    <div class="card shadow-lg p-4 my-5" style="max-width: 400px; width: 100%; z-index: 1">
...
<!--            WAVES-->
            ...
            <svg class="custom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                 style="position:absolute; bottom:-300px; left:0; width:100%; height:auto; z-index: 0">
