...
<head>
    ...
    <title>Orvos bejelentkezés</title>
</head>
<body>
...
<div class="d-flex justify-content-center align-items-center vh-100 bg-light">
    <div class="d-flex justify-content-center align-items-center card shadow-lg p-4" style="max-width: 400px; width: 100%; z-index: 1">
        <img class="text-center" src="images/doctor_log.png" alt="Logo" style="max-width: 80px;">
        <h5 class="text-center my-4">Bejelentkezés</h5>
